...
const FullStack = () => {
  const user = [
    ...
    },
    {
      id: 4,
      image:
        "https://res.cloudinary.com/dofdsgzno/image/upload/v1714456249/React-Router/career/ehuytpmdnsivjj3xgkcg.webp",
    ...
    },
    {
      id: 5,
      image:
        "https://res.cloudinary.com/dofdsgzno/image/upload/v1714456251/React-Router/career/zbe5fbh50dc1qzmhksoc.webp",
    ...
    },
    {
      id: 6,
      image:
        "https://res.cloudinary.com/dofdsgzno/image/upload/v1714456250/React-Router/career/lzcfkyf8m75o1thbn1wb.jpg",
    ...
    },
    {
      id: 7,
      image:
        "https://res.cloudinary.com/dofdsgzno/image/upload/v1714456255/React-Router/career/nzju1cisrhanyyjoeeyq.webp",
          ...
          {user.map((item) => (
            <div key={item.id} className="card">
              ...
              <div className="card-body text-muted">
                <p className="card-text text-decoration-none">By {item.user}</p>
                <p className="card-text text-decoration-none">
                  {item.date}
                  <span className="gap">{item.time} Min Read</span>
                </p>
              </div>
            </div>
          ))}
